...
class Colors:
    ...
    def __init__(self):
        ...
        hex = ('FF3838', '00FF00', 'FF701F', 'FFB21D', 'CFD231', '48F90A', '92CC17', '3DDB86', '1A9334', '00D4BB',
...
def plot_one_box(x, im, color=(128, 128, 128), label=None, line_thickness=3,coords = [[600, 800], [300, 800], [400, 400], [550, 400]]):
    # Plots one bounding box on image 'im' using OpenCV
    assert im.data.contiguous, 'Image not contiguous. Apply np.ascontiguousarray(im) to plot_on_box() input image.'
    tl = line_thickness or round(0.002 * (im.shape[0] + im.shape[1]) / 2) + 1  # line/font thickness
    cv2.line(im,coords[1],coords[2],(255,0,0),5)
    cv2.line(im, coords[0], coords[3], (255, 0, 0), 5)
    cv2.line(im, coords[2], coords[3], (255, 0, 0), 5)
